 ...
 */
public class WhjSendQueryGetter extends BaseGetter {

	@Override
	public Result call() throws AppException {
		try {
			
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "发送日志查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		return whjXfService.queryWhjSend(pageIndex, pageSize,startDate,brno);
	}
