...
public class WhjTxQueryGetter extends BaseGetter {

	@Override
	public Result call() throws AppException {
		try {
			
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "银行卡境外提现明细查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		return whjTxService.queryWhjTx(pageIndex, pageSize,acctno, personName,startDate,brno);
	}
