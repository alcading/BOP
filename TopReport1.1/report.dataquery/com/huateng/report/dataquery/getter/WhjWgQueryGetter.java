...
import com.huateng.report.dataquery.service.WhjWgService;
 ...
 */
public class WhjWgQueryGetter extends BaseGetter {

	private static final Logger logger = Logger.getLogger(WhjWgQueryGetter.class);
	@Override
	public Result call() throws AppException {
		try {
			
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "反馈数据错误信息");
	...
	private PageQueryResult getData() throws CommonException {
		...
		WhjWgService whjWgService = WhjWgService.getInstance();
		return whjWgService.queryWhjWg(pageIndex, pageSize,jgbs, rq,brno);
	}
