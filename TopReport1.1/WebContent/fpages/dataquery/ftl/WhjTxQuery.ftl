...
CommonQueryMacro> <@CommonQueryMacro.page title="境外提现明细插叙">

<@CommonQueryMacro.CommonQueryTab id="whjTxQueryTabs" navigate="false"
currentTab="WhjTxQuery"> <@CommonQueryMacro.CommonQuery id="WhjTxQuery"
...
<table align="left" width="80%">
	...
	<tr>
		<td><@CommonQueryMacro.DataTable id ="datatable1"
			fieldStr="operTypeCodeS,reasonCode,refNo,certTypeCodeS,ptyCountryCodeS,idCode,personName,acctno,jyCcyCodeS,jyAmt,qsAmtRmb,mccCode,cardTypeCodeS,cardChnlCodeS,bankCode,branchSafecode,bizDealTime,countryCodeS,bankSelfNum,cardSelfNum" 
