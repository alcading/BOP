...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%">
	...
	<tr valign="top" height="232px">
		<td align="center"><img src="<%=request.getContextPath() %>/login/images/login_top1.gif" border="0"/></td>
	</tr>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="595px" height="210xp" background="<%=request.getContextPath() %>/login/images/bg_panel_login.png">
		<tr>
			...
			<tr height="35px">
				...
				<td width="100%">
				<input type="text" name="brCodeName" id="brCodeName"  value="--请选择机构--" class="inputcls" readonly="readonly" style="cursor: default;" onclick="showO()"/><p>
				<div id="brCodeSelect" style="position:absolute;width:auto;">
					...
					%>
					<li><a href="javascript:setBrCode('<%=bctl.getBrno()+"-"+bctl.getBrname() %>','<%=bctl.getBrcode() %>');" id="bctl_<%=bctl.getBrcode() %>"><%=bctl.getBrno()+"-"+bctl.getBrname() %></a></li>
					<%} %>
					</ol>
				</div>
				</p>
